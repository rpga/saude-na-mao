...
public class BD {
	...
	public void povoarUds () {
		Uds u1 = new Uds(1,1, "Hospital Agamenon Magalhăe","Estrada Do Arraial", "Recife",2723,"Casa Amarela");
		Uds u2 = new Uds(2,1,"Hospital Da Restauraçăo","AV. Agamenon Magalhaes", "Recife",0,"Derby");
	...
	public void inserir(Especialidade especialidade){
		ContentValues valor = new ContentValues();
		valor.put("_id", especialidade.getId());
	...
	public void inserir(Uds uds){ 
		ContentValues valor = new ContentValues();
		valor.put("_id", uds.getId());
		valor.put("cod_tipo", uds.getCod_tipo());
	...
	public void inserir(Possui possui){
		ContentValues valor = new ContentValues();
		valor.put("_id", possui.getCod_uds());
		valor.put("cod_uds", possui.getId());
